...
As the distance from the source of energy increases, the area over which the electric and magnetic energy is spread is increased, so that the available energy per unit area is decreased. </br>
Radio signal intensity, like light intensity, decreases as the distance from the source increases. </br>
A transmitting antenna is a device that projects the radio-frequency energy generated by a transmitter into space. </br>
